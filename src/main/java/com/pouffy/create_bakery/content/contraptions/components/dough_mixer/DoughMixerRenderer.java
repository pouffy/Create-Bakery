...
public class DoughMixerRenderer extends KineticTileEntityRenderer {
    public DoughMixerRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    protected void renderSafe(KineticTileEntity te, float partialTicks, PoseStack ms, MultiBufferSource buffer, int light, int overlay) {
        if (!Backend.canUseInstancing(te.getLevel())) {
            ...
            SuperByteBuffer headRender = CachedBufferer.partial(BakeryBlockPartials.DOUGH_MIXER_HEAD, blockState);
